...
export default function Courses() {
  ...
  return (
    <div className="bg-[#0a0a0a] text-white selection:bg-primary selection:text-black pt-32 lowercase-disabled">
      {/* Header */}
      <header className="px-6 md:px-8 max-w-7xl mx-auto py-16 lg:py-24 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="fade-up text-center lg:text-left">
              ...
              <h2 className="font-headline text-3xl md:text-7xl font-bold uppercase mb-10 leading-[1.1]">
                What <br />
                <span className="gold-shimmer italic font-light">Certificate Will <br /> You Earn?</span>
              </h2>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 md:mb-24 fade-up text-center md:text-left">
            <div>
              ...
              <h2 className="font-headline text-3xl md:text-6xl font-bold uppercase">Course <span className="gold-shimmer italic font-light">Highlights.</span></h2>
            </div>
      ...
      <section className="py-20 lg:py-24 bg-[#141414] border-t border-white/5">
         <div className="max-w-4xl mx-auto px-6 md:px-8 text-center fade-up">
            <h2 className="font-headline text-2xl md:text-5xl font-bold mb-10 text-white uppercase italic">Ready to master the craft?</h2>
