    ...
    <div className="bg-[#0a0a0a] text-white selection:bg-primary selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="fade-up order-1 lg:order-2 text-center lg:text-left">
              ...
              <h2 className="font-headline text-3xl md:text-6xl font-bold uppercase mb-8 md:mb-10 leading-tight">Modern Trends. <br /><span className="gold-shimmer italic font-light">Timeless Aesthetics.</span></h2>
      ...
      <section className="py-20 lg:py-24 bg-[#141414] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4">
          <div className="md:col-span-2 luxury-card bg-[#1a1a1a] p-10 md:p-12 border border-white/5 flex flex-col justify-between h-[250px] md:h-[300px] fade-up relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 fade-up text-center md:text-left">
            <div>
              ...
              <h2 className="font-headline text-3xl md:text-6xl font-bold uppercase">The Artist <span className="gold-shimmer italic font-light">In Focus.</span></h2>
            </div>
      ...
      <section className="py-24 lg:py-40 relative">
        <div className="max-w-4xl mx-auto px-6 md:px-8 text-center fade-up">
           ...
           <h2 className="font-headline text-2xl md:text-5xl font-bold mb-10 md:mb-12 uppercase tracking-tight leading-tight italic px-4">
